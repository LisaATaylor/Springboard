...
SELECT name as facname, CONCAT( firstname,  ' ', surname ) AS guestname, CASE WHEN Bookings.memid =0
...
SELECT name AS facname, starttime, CONCAT( firstname,  ' ', surname ) AS guestname, 
CASE WHEN Bookings.memid =0
THEN guestcost * slots
ELSE membercost * slots
END AS totalcost
